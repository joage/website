...
const TMB = () => (
  <Post title="Courmayeur (TMB Part 1)" date="July 2, 2023" prev="/adventures/leaving-ny">
    <ImageGroup images={[{path: "/images/IMG_3993.jpeg", caption: "High point of the day!"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_3947.jpeg", caption: "Leaving Courmayeur"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_3955.jpeg", caption: "Rifugio Bertone"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_4002.jpeg", caption: "The descent from Col Sapin"}]} />
    
    <ImageGroup images={[{path: "/images/IMG_4007.jpeg", caption: "High route was worth it"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_4020.jpeg", caption: "Approaching Bonatti, clouds lifted so we could see the Mont Blanc Massif"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_4039.jpeg", caption: "Seeing cows means that we are getting close to a hut"}]} />
    ...
    <ImageGroup images={[{path: "/images/IMG_4008.jpeg", caption: ""}, {path: "/images/IMG_4033.jpeg", caption: ""}]} />
  </Post>
);
