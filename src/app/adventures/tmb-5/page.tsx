...
const TMB = () => (
  <Post title="Goats and Lakes (TMB Day 5)" date="July 6, 2023" prev="/adventures/tmb-4" next="/adventures/tmb-6">
    ...
    <ImageGroup images={[{path: "/images/tmb/IMG_4327.jpeg", caption: "One of the Lacs de Cheserys"}]} />

    <ImageGroup images={[{path: "/images/tmb/IMG_4351.jpeg", caption: ""}, {path: "/images/tmb/IMG_4352.jpeg", caption: ""}]} />

    <ImageGroup images={[{path: "/images/tmb/IMG_5036_Original.jpeg", caption: "Lake where I went for a swim. It was cold"}]} />

    <ImageGroup images={[{path: "/images/tmb/IMG_4369.jpeg", caption: "These guys have impressive horns"}]} />

    <ImageGroup images={[{path: "/images/tmb/IMG_4378.jpeg", caption: "Lac Blanx"}]} />
