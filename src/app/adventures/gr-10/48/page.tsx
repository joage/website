...
const GR = () => (
  <Post title="My long walk in the Pyrenees (HRP Recap)" date="September 5, 2023" prev="/adventures/gr-10/47">
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5396.jpeg", caption: ""}]} />
...
My french has gotten better. Talking to strangers was often a necessity in the mountains, so I improved faster than I ever did in a classroom. However I still cannot speak Spanish or Catalan.

Through numerous mistakes, I have learned things about thru-hiking, gear, food, and pack weight that will be handy for the next adventure.
