...
const GR = () => (
  <Post title="My long walk in the Pyrenees (HRP Recap)" date="September 5, 2023" prev="/adventures/gr-10/47">
    <ImageGroup images={[{path: "/images/gr-10/IMG_4615.jpeg", caption: "Day 4", link: "/adventures/gr-10/4"}, {path: "/images/gr-10/IMG_4974.jpeg", caption: "Day 14"}]} />
...
<p>My favorite section is hard to say. Basque Country was wet, but I made friends. Lescun to Gavarnie was magnificent and popular. Gavarnie to Salardu was the most epic and difficult. Salardu to L’Hospitalet was wild and lonely. L’Hospitalet to Banyuls was surprisingly beautiful, and hot towards the end.</p>
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5396.jpeg", caption: "Day 25"}, {path: "/images/gr-10/8cf1fb5c-92df-4e86-b0d3-70684506ea66.jpeg", caption: "Day 34"}]} />
    <ImageGroup images={[{path: "/images/gr-10/IMG_5127.jpeg", caption: "Day 18"}, {path: "/images/gr-10/IMG_5567.jpeg", caption: "Day 31"}]} />
