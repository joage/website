...
const GR = () => (
  <Post title="Tired (HRP Day 39)" date="August 18, 2023" prev="/adventures/gr-10/38" next="/adventures/gr-10/40">

    <ImageGroup images={[{path: "/images/gr-10/IMG_5847.jpeg", caption: "How I felt today"}]} />
...
In the morning I got a pastry and a curry chicken suedois from the bakery Fournil de Louise in L’Hospitalet. There I met a talkative Dutch guy who was beginning his HRP westbound trek today, having just gotten off the train. I wish I had his energy as I climbed out of town on the steep forested hillside.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5840.jpeg", caption: "Climbing out of L'Hospitalet"}]} />
...
<p>Eventually I felt so exhausted and sleepy that I laid down on a large flat rock to take a nap. It was not my day, but at least I wasn’t in a rush to get anywhere.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_5841.jpeg", caption: "A nap at 10am"}]} />

Around noon I woke up and continued to the climb, still feeling slow.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5843.jpeg", caption: "Lac des Besines"}]} />
...
<p>Two Belgians and a Hungarian guy arrived as I was finishing my food. Since their english was better then their french, we got along. I left before them to continue climbing to the col.</p>
...
I had some more energy now, and the trail followed the GR 10 so it was pretty easy. I still went super slowly on the steep parts.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5844.jpeg", caption: "Tired but in a beautiful place"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5845.jpeg", caption: "Getting close to the col"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5848.jpeg", caption: "At last, the end of the horrible climb!"}]} />
...
<p>After I passed a shepherd herding his flock, I reached a small cabin where a some hikers, all French, had set up camp. I asked them where they had gotten water, and they directed me to a trickling stream. I sat for a while next to a group of horses and did some route planning on my phone.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_5852.jpeg", caption: "I wondered why the horses kept sniffing each other’s butts in a line, but eventually I realized they were flicking the annoying flies off each other’s eyes with their tails! Very cooperative, but unless it’s a circle, the first horse never gets any benefit from this scheme."}]} />

After some time, I decided on a plan. I would not do Carlit the next day, and instead take the GR 10 over a small col.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5854.jpeg", caption: "Back on the GR 10"}]} />
...
After the col, I entered a new valley. As usual, horses were present near the top, but as I descended further, cows replaced them.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5857.jpeg", caption: "A new valley"}]} />
...
<p>As the sun set, I cooked dinner. It was a long day, but it was ending on a good note! I felt progressively better during the last few kms of the hike.</p>
