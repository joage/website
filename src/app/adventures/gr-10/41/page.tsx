...
<p>When I looked outside, I saw the two Belgians approaching! I keep running into these guys. Apparently, they had seen me hike past their tent last night.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_5893.jpeg", caption: "Where I woke up"}]} />

Today I planned to walk the border ridgeline to Refugi Ull de Ter and hit a few peaks along the way.

<p>The morning climb began in the shade. I was worried I would crash again, like my climb out of L’Hospitalet two days ago, but today I felt a bit more energized after a breakfast of bread, peanut butter, and sheep’s cheese.</p>
...
After a couple stops to refill my water at a stream and put on sunscreen, I continued the climb up the Vallée d’Eyne. Near the top of the col, I saw a group of 5 or 6 isards leaping across the trail.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5896.jpeg", caption: "The valley widened out near the top"}]} />

I made it to the col after 1.5 hours. It was tiring, but I felt much better than two days ago.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5899.jpeg", caption: "Pic d'Eyne, 2789m"}]} />
...
I passed by quite a few people today, and since I was walking along the border of France and Catalonia, I needed to pick a language to say hi to people. Pretty soon I got good at guessing the right language. I noticed that many of the day hikers/runners spoke spanish and catalan, and they traveled in big groups.  The backpackers who looked a bit shy were most likely french.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5913.jpeg", caption: ""}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5914.jpeg", caption: ""}]} />

The last peak in the chain, Pic de la Vaca, had white rocks as its unique feature.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5916.jpeg", caption: "Pic de la Vaca 2826m"}]} />
...
By the time I reached Pic de la Vaca, clouds had formed overhead. There were supposed to be some thunderstorms this afternoon. 
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5926.jpeg", caption: "Freser valley"}]} />
...
<p>I got a drink and chatted with two French guys from Paris who were going in my direction on the HRP. Water was going to be scarce for the next 25 km.</p>
...
<p>The food truck was located at a ski resort, and the HRP conveniently passed right through it.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_5928.jpeg", caption: "I got a burger and a tray of patatas bravas served with a slightly spicy aioli at Vallter 2000"}]} />
...
<p>With my bag heavily loaded, I walked up to a col with a lot of flat land for camping. On the way up, I kept watching the darkened sky and hoping that it wouldn’t start to rain.</p>
...
I set up my tent and threw all my gear inside. I laid down inside and waited, but the storm never came. I could see the clouds in the distance drooping down and connecting with the land. At one point I heard thunder but it was far away. Not a single drop of rain hit my tent today.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5931.jpeg", caption: "Pla de coma Ermada"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5933.jpeg", caption: "Dinner ingredients"}, {path: "/images/gr-10/IMG_5934.jpeg", caption: "Dinner!"}]} />
...
After I made dinner, the sun came out again for a brief moment before setting behind the mountains. I went for a short walk to get a view of Pic de Canigou then returned to my tent to sleep.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5935.jpeg", caption: "Camping on a col with all my water"}]} />
