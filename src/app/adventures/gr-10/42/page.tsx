...
<p>As I got up to pee, I saw some isards grazing at the other end of my col. As I kept watching, more of them appeared far in the distance, an entire herd! There must have been at least a hundred.</p>
...
<p>After a long breakfast I set off. The day began with more traversing tall grassy ridgelines. I met a group of friendly hikers from spain as I hiked along the crête leading to Canigou.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_5957.jpeg", caption: "Caught up to the elusive isards"}]} />

When I passed a section of more narrow trail, I saw the rocks turn from grey to a striking white color.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5961.jpeg", caption: "White and green rocks"}]} />
...
The kilometers flew by this morning, since the trail was pretty flat. I caught up to a shepherd with her three dogs. She explained that she had about 100 sheep on the other side of the hill we were walking on. When I asked if she had any cheese to sell, she said that all her sheep were young (lambs), and were raised for their meat, not their milk! I pondered my own consumption of lamb for a bit, after we parted ways.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5963.jpeg", caption: "Pla Guillem, where the normal trail turns left to go to Mariailles but the high path continues straight ahead over the peaks"}]} />
...
At the Pla Guillem, I was supposed to turn left to go to Refuge des Mariailles, but as I routed my track on Mapy.cz, I realized there was a “shorter” route continuing on the ridge line toward Canigou. Just then, a guy approached from the direction of Mariailles, vlogging with his camera. It turned out that he was a youtuber from Barcelona. We chatted and he confirmed my belief that Mariailles was too out of the way. Since I still had plenty of water remaining. I left the HRP here to try this shorter, higher route.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5966.jpeg", caption: "Ascending Pic des Sept Hommes"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5969.jpeg", caption: "Pic des Sept Hommes, 2651m"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5976.jpeg", caption: "A lone isard on the hill"}]} />
...
The high route took me to the summits of Pic des Sept Hommes and Puig Roja by an easy trail, similar to yesterday’s ridge walk. After the second peak, the ridge became increasingly rocky and steep. 
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_5989.jpeg", caption: "Great view of Pic de Canigou from the ridge"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_5993.jpeg", caption: "Short traverse through a boulder section"}]} />

I followed some cairns to a col where I saw a faint trail going down to some lakes.

    <ImageGroup images={[{path: "/images/gr-10/IMG_5996.jpeg", caption: "I left the ridge here to descend"}]} />
...
Although it was incredibly steep and loose, the descent ended before I stopped having fun. At the bottom I passed three green, unswimmable lakes where I debated whether to set up camp or keep going.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_6001.jpeg", caption: "Made it to the lakes"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_6005.jpeg", caption: "Gorgs de Cady, the lake water was not inviting for swimming. I only dipped my feet in to wash my legs."}]} />
...
<p>After some thought, I decided to attempt the summit of Canigou and sleep on the other side. I didn’t want to camp here because the water did not look tasty and the ground was rough. My legs felt strong, and I had plenty of energy today.</p>
...
Luckily none of these things happened on my climb. During the last 10 meters I started hearing voices above me, meaning I had made it! It was a classic scramble with a top-out right at the summit.
    ...
    <ImageGroup images={[{path: "/images/gr-10/IMG_6022.jpeg", caption: "Pic de Canigou, 2784m. My favorite summit of the HRP!"}]} />
...
<p>A clap of thunder in the distance got me back on my feet to start going down. Although the sky looked dark, it never started to rain, just like yesterday.</p>

    <ImageGroup images={[{path: "/images/gr-10/IMG_6032.jpeg", caption: "Interesting cloud formation on the descent to Cortalets"}]} />

    <ImageGroup images={[{path: "/images/gr-10/IMG_6035.jpeg", caption: "Estanyol (pond)"}]} />
...
<p>It was my first refuge dinner in a while, and I met lots of people who where looking to climb Canigou the next day.</p>
