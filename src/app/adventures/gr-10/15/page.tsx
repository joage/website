...
const GR = () => (
  <Post title="Reaching new heights (HRP Day 15)" date="July 25, 2023" prev="/adventures/gr-10/14">
    ...
    <ImageGroup images={[{path: "/images/IMG_4983.jpeg", caption: "Morning mist covers Pic du Midi"}]} />
...
Continuing on, we climbed into a valley where the weather began to deteriorate. In between bouts of rain and fog, we caught glimpses of beautiful blue lakes.
    ...
    <ImageGroup images={[{path: "/images/IMG_4993.jpeg", caption: "Classic milk carton cow"}]} />

Some time later, we stopped to have lunch by the closed refuge d’Arrémoulit.

    <ImageGroup images={[{path: "/images/IMG_4999.jpeg", caption: "Cheese from the shepherd and jamón from Spain. Happy"}]} />

    <ImageGroup images={[{path: "/images/IMG_5011.jpeg", caption: "Lacs d'Arrémoulit"}]} />
...
The next part was a tricky section of boulder fields and navigating two Cols. We followed cairns up to the Col du Palas, and then traversed the steep rocky hillside to Port du Lavedan.
    ...
    <ImageGroup images={[{path: "/images/IMG_5016.jpeg", caption: "Jacques ascending the boulder field"}]} />

    <ImageGroup images={[{path: "/images/IMG_5021.jpeg", caption: "Top of the first col, Col du Palas"}]} />

    <ImageGroup images={[{path: "/images/IMG_5026.jpeg", caption: "Tricky traverse to the second col"}]} />

    <ImageGroup images={[{path: "/images/IMG_5031.jpeg", caption: "Bluest alpine lakes"}]} />

    <ImageGroup images={[{path: "/images/IMG_5042.jpeg", caption: "Climbing the final chimney up to the Port du Lavedan, 2615m"}]} />
...
This was the highest elevation of my trip so far, and also the biggest gain in a day–perhaps why the ensuing descent felt more grueling than previous days.
    ...
    <ImageGroup images={[{path: "/images/IMG_5045.jpeg", caption: "Descending to Larribet"}]} />
