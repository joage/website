...
const TMB = () => (
  <Post title="Cabin on a glacier (TMB Day 4)" date="July 5, 2023" prev="/adventures/tmb-3" next="/adventures/tmb-5">
    <ImageGroup images={[{path: "/images/tmb/IMG_4273.jpeg", caption: "Climbing up to Albert Premier Refuge"}]} />
    ...
    <ImageGroup images={[{path: "/images/tmb/IMG_4170.jpeg", caption: "View from Gîte La Casita where we slept"}]} />
    ...
    <ImageGroup images={[{path: "/images/tmb/IMG_4220.jpeg", caption: "Highlights from our own route"}]} />

    Upon reaching Col de Balme, I had the most amazing omelette in the refuge—we were now in France!

    <ImageGroup images={[{path: "/images/tmb/IMG_4227.jpeg", caption: "Col de Balme, border of Switzerland and France"}]} />
