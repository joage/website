...
const TMB = () => (
  <Post
    title="Wine Tour du Mont Blanc"
    date="July 2023"
    prev="/adventures/tmb-5"
    next="/adventures/gr-10/1"
    stravaID="10454107560"
  >
    <ImageGroup images={[{ path: "/images/tmb/IMG_3972.jpeg", caption: "" }]} />
    <p>
      Day 6 was the uneventful hike down to the bus station so instead of
      writing about it I’ll focus on the food we ate during the entire trip.
    </p>
    <p>
      Mont Blanc is not just about nature, its also about eating, drinking, and
      sampling the cuisine of 3 countries because you are never too far from a
      village with a food store. With the exception of Danish canned fish (from
      my 2 day layover in Copenhagen) and random junk food snacks, everything
      else we packed was local to the region we were in!
    </p>
    <ImageGroup
      images={[
        {
    ...
    <p>
      ...
      France. Emma had to go back to work, so I will be solo for the rest of my
      time in Europe!
    </p>
    <ImageGroup
      images={[{ path: "/images/tmb/IMG_5080_Original.jpeg", caption: "" }]}
    />
  </Post>
);
