...
const TMB = () => (
  <Post title="Champex to Finhaut (TMB Day 3)" date="July 4, 2023" prev="/adventures/tmb-2" next="/adventures/tmb-4">
    ...
    <ImageGroup images={[{path: "/images/tmb/IMG_4119.jpeg", caption: "The notch is the col named Fenêtre d'Arpette"}]} />
    <ImageGroup images={[{path: "/images/tmb/IMG_4124.jpeg", caption: "Almost at the col"}]} />

    At 1100m of ascent, we crested the col and peered into the Trient valley below.
    
    <ImageGroup images={[{path: "/images/tmb/IMG_4130.jpeg", caption: "Top!"}]} />

    <ImageGroup images={[{path: "/images/tmb/IMG_4119.jpeg", caption: "The other side"}]} />

    We took in the views, had lunch, and started the long descent to Trient with no shade. 

    <ImageGroup images={[{path: "/images/tmb/IMG_4136.jpeg", caption: "Trient Glacier"}]} />
    ...
    <ImageGroup images={[{path: "/images/tmb/IMG_4161.jpeg", caption: "Finhaut"}]} />
